...
Sources section. Findings feed `Issues-And-Comments-Log.md` section 6k
(PL-series).
...
`ASX-PlanSemantics-Draft.ttl`; a stale clone initially hid the branch - log
item S5). The two efforts converge strongly - independent derivations
...
## 5. Findings (PL-series; logged in Issues-And-Comments-Log 6k)
...
> PL8/PL9/PL10 with the updated statuses in log 6k (PL7/PL8/PL9 now MODULE
...
Module side: `../Proposed Extension Working Materials/
Plan-Semantics-Analysis.md`, `ASX-PlanSemantics-Draft.ttl`,
